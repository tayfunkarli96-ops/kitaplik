...
const ARSIV_DATA = [
  { id: '1', title: "Fight Club", director: "David Fincher", year: "1999", genres: "Action", imdb: "8.8", poster: "https://image.tmdb.org/t/p/w500/pB8BM7pdSp6B6Ih7QZ4DrQ3PmJK.jpg" },
  ...
  { id: '6', title: "The Dark Knight", director: "Christopher Nolan", year: "2008", genres: "Action", imdb: "9.0", poster: "https://image.tmdb.org/t/p/w500/qJ2tW6WMUDw954Y72Vd5S4WvUE.jpg" },
  ...
  { id: '14', title: "The Prestige", director: "Christopher Nolan", year: "2006", genres: "Drama", imdb: "8.5", poster: "https://image.tmdb.org/t/p/w500/bdN3gvl98m96SpxYm8_3bhb.jpg" },
            ...
            {filtered.map((m, i) => (
              <div key={m.id} className={i % 2 === 0 ? "neon-box-pink" : "neon-box-cyan"} style={{ display: 'flex', padding: '15px', gap: '20px', alignItems: 'center' }}>
                ...
                <div>
                  ...
                  <div style={{ color: '#f5c518', fontWeight: 'bold' }}>⭐ {m.imdb}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{ position: 'sticky', top: '100px', height: 'fit-content', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div className="neon-box-cyan" style={{ padding: '20px' }}>
              ...
              <div style={{ fontSize: '14px', color: '#ccc' }}>
                <p>👤 "Tasarım efsane akıyor!"</p>
                <p>👤 "Arama motoru canlanmış."</p>
              </div>
            </div>
          </div>
        </div>
