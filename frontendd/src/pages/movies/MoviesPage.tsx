...
// 🎬 15 DEV FİLM (Tayfun Karlı Yönetmenliğinde!)
const FILMLER = [
  { id: '1', title: "Fight Club", director: "Tayfun Karlı", year: "1999", genres: "Drama/Action", imdb: "8.8", poster: "https://image.tmdb.org/t/p/w500/pB8BM7pdSp6B6Ih7QZ4DrQ3PmJK.jpg" },
...
const MoviesPage = () => {
  ...
  const filtrelenenler = FILMLER.filter(f => f.title.toLowerCase().includes(term.toLowerCase()));

  return (
    <div style={{ backgroundColor: '#05050a', minHeight: '100vh', color: '#fff', padding: '40px 20px' }}>
      <style>{`
        ...
        .btn-pink { background: #ff00ff; color: #fff; border: none; padding: 10px 25px; border-radius: 20px; font-weight: bold; cursor: pointer; }
      `}</style>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '30px' }}>
          ...
          <div style={{ position: 'sticky', top: '80px', height: 'fit-content', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div className="box-pink" style={{ padding: '20px', textAlign: 'center' }}>
              <h3 style={{ color: '#00f3ff' }}>Stats</h3>
              <div style={{ fontSize: '30px', fontWeight: 'bold' }}>{filtrelenenler.length} Film</div>
            </div>
            <div className="box-pink" style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <div className="box-cyan" style={{ padding: '15px' }}>
              ...
              <div style={{ fontSize: '13px', color: '#ccc' }}>
                <p>👤 "Siberpunk arayüz akıyor moruk!"</p>
                <p>👤 "Tayfun Karlı yine döktürmüş."</p>
              </div>
            </div>
          </div>
        </div>
