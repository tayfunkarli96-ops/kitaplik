...
// 🎬 BU LİSTEYİ BAŞKA HİÇBİR YERDEN ÇEKME, DİREKT BURADAN OKU!
const SİBER_ARSİV = [
...
const MoviesPage = () => {
  ...
  const filtered = SİBER_ARSİV.filter(m => m.title.toLowerCase().includes(term.toLowerCase()));
    ...
    <div style={{ backgroundColor: '#05050a', minHeight: '100vh', color: '#fff', padding: '100px 30px', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '30px', marginTop: '30px' }}>
          ...
          {/* SAĞ: STATS, COMMENT VE GÖRÜŞLER (ARTIK DİNAMİK VE ŞIK) */}
