...
// --- 🎬 15 FİLMLİK DEV LİSTE ---
const FILMLER = [
  { id: '1', title: "Fight Club", director: "David Fincher", year: "1999", genres: "Action/Drama", imdb: "8.8", poster: "https://image.tmdb.org/t/p/w500/pB8BM7pdSp6B6Ih7QZ4DrQ3PmJK.jpg" },
  ...
  { id: '7', title: "Pulp Fiction", director: "Tarantino", year: "1994", genres: "Crime", imdb: "8.9", poster: "https://image.tmdb.org/t/p/w500/fIE3lYDrK4S5I56yAAnAn5CAndY.jpg" },
  { id: '8', title: "The Godfather", director: "Coppola", year: "1972", genres: "Crime", imdb: "9.2", poster: "https://image.tmdb.org/t/p/w500/3bhb76346b96b42b6a555986b.jpg" },
  ...
  { id: '12', title: "Blade Runner 2049", director: "Villeneuve", year: "2017", genres: "Sci-Fi", imdb: "8.0", poster: "https://m.media-amazon.com/images/I/71Y87B57XkL._AC_SL1200_.jpg" },
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '30px', marginTop: '30px' }}>
              ...
              <Link to={`/movie/${m.id}`} key={m.id} style={{ textDecoration: 'none', color: 'inherit' }}>
                <div className={i % 2 === 0 ? "neon-box-pink" : "neon-box-cyan"} style={{ display: 'flex', padding: '15px', gap: '20px', alignItems: 'center' }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: '#aaa', margin: 0 }}>Yönetmen: {m.director} | Yıl: {m.year}</p>
                    <div style={{ marginTop: '10px', color: '#f5c518' }}>⭐ {m.imdb}</div>
                  </div>
                </div>
              </Link>
            ))}
          ...
          <div style={{ position: 'sticky', top: '100px', height: 'fit-content', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div className="neon-box-pink" style={{ padding: '20px', textAlign: 'center' }}>
              <h3 style={{ color: '#00f3ff' }}>Stats</h3>
              <div style={{ fontSize: '30px', fontWeight: 'bold' }}>{filtered.length} Film</div>
            </div>
            <div className="neon-box-pink" style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <div className="neon-box-cyan" style={{ padding: '15px' }}>
              <h3 style={{ color: '#00f3ff', fontSize: '18px' }}>Son Görüşler</h3>
              <div style={{ fontSize: '13px', color: '#ccc' }}>
                <p>👤 "Arayüz resmen akıyor moruk!"</p>
...
// BU SATIRI UNUTURSAK VERCEL HATA VERİR:
